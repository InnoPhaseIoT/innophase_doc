...
.. table:: Table 5: Potential values of the connection state
...
.. table:: Table 6: Potential values of the scan state

   +-----------------------------------------------------------------------+
   | { "result": [ {"ssid":<ssid string>", "bssid":"<bssid string>",       |
   | "channel":<channel num str>}…….]}                                     |
   +=======================================================================+
   +-----------------------------------------------------------------------+
