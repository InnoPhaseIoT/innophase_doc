...
8. Select the check box Authority / Update Site and Always trust all
   authorities and Click on Trust Selected -> Yes, I Accept the Risk

|image7|

|A screenshot of a computer error Description automatically generated|

Figure 16: Plugin installation – Trust Authorities

9. Select the check box Unsigned & Always trust all content and Click on
...
Figure 17: Plugin installation – Trust unsigned content

10. Software begins to install, which is indicated in the status bar.

|A screen shot of a computer Description automatically generated|\ c

Figure 18: Plugin installation – Installing software status

11. Once software installation is complete, a pop-up message for
    restarting appears. Click on Restart Now.

|A screenshot of a software update Description automatically generated|

Figure 19: Plugin installation – Restart Now after installation

12. On successful installation, Eclipse IDE will have a tab for
    InnoPhase IoT on restarting.

|image9|

Figure 20: Plugin installation – InnoPhase IoT menu
...
Figure 21: Download and configure support files menu
...
Figure 22: Download and configure support files - Input window
...
Figure 23: Download and Configure Support Files – Status message
...
Figure 24: Import an existing example in Eclipse
...
Figure 25: Import existing code as makefile project
...
Figure 27: Eclipse Run As – Select Run Configuration
...
Figure 28: InnoPhase IoT Software Development Tool – New Run
Configuration
...
Figure 29: InnoPhase IoT Software Development Tool – Run configuration
input window
...
Figure 30: Console Window – CDT build console
...
Figure 31: InnoPhase IoT T2 Device Monitor Console Window – Run
configuration
...
Figure 32: Eclipse Debug As – Select debug configuration
...
Figure 33: InnoPhase IoT Software Development Tool – New debug
configuration
...
Figure 34: InnoPhase IoT Software Development Tool – Debug configuration
input window
...
..
   ...
   Figure 35: InnoPhase IoT Software Development Tool – Debug
   perspective switch
...
Figure 36: InnoPhase IoT Software Development Tool – Debug start
...
.. |image7| image:: media/image8.png
   :width: 6.29921in
   :height: 5.16652in
.. |A screenshot of a computer error Description automatically generated| image:: media/image9.png
   :width: 6.29921in
   :height: 2.61011in
.. |image8| image:: media/image10.png
   :width: 6.88976in
   :height: 4.25634in
.. |A screenshot of a computer error message Description automatically generated| image:: media/image11.png
   :width: 6.88976in
   :height: 2.97571in
.. |A screen shot of a computer Description automatically generated| image:: media/image12.png
   :width: 6.88976in
   :height: 0.74912in
.. |A screenshot of a software update Description automatically generated| image:: media/image13.png
   :width: 6.88976in
   :height: 1.95793in
...
.. |image11| image:: media/image16.png
   :width: 6.88976in
   :height: 2.89731in
.. |A screenshot of a message Description automatically generated| image:: media/image17.png
   :width: 6.88976in
   :height: 2.00514in
.. |Graphical user interface, application Description automatically generated| image:: media/image18.png
   :width: 3.93701in
   :height: 4.04292in
.. |Graphical user interface, text, application, email Description automatically generated| image:: media/image19.tmp
   :width: 4.72441in
   :height: 4.29633in
...
.. |image15| image:: media/image23.png
   :width: 6.49606in
   :height: 3.57404in
.. |image16| image:: media/image24.png
   :width: 5.90551in
   :height: 1.2407in
