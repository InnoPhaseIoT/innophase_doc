...
Launch the Download tool and configure the following in the GUI window:
    ...
    - ELF Input: Load the helloworld.elf by clicking on Select ELF File.

    - Programming: Click PROG Flash to Program Talaria TWO with helloworld.elf
