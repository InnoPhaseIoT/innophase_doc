...
|image3| \ Figure : Setting host interface baudrate
...
|image4| \ Figure : Set maximum size of host message
...
|image5| \ Figure : Set default MAC address of the device
...
|image6| \ Figure : Set baudrate for device console output
...
|image7| \ Figure : Enable coredump via UART after crash
...
|image8| \ Figure : Set the GPIO 13 pin as input with pull up
...
|image9| \ Figure : Set the ARP period to 90 (s)
...
|image10| \ Figure : Set the Wi-Fi to use channels 1 to 6 and 11
...
|image11| \ Figure : Turning dynamic listening ON
...
|image12| \ Figure : Set the beacon listening interval to 10
...
|image13| \ Figure : Set the max idle time to 300 (s)
...
|image14| \ Figure : Set the traffic timeout value to 24 (ms)
...
|image15| \ Figure : Turn ON the Wi-Fi Tx power save mode
...
|image16| \ Figure 16: Turn ON the Wi-Fi DTIM only listening mode
...
.. |Table Description automatically generated with medium confidence| image:: media/image1.png
   :width: 7.08661in
   :height: 1.49772in
.. |image1| image:: media/boot2.png
   :width: 1.59167in
   :height: 0.225in
.. |image2| image:: media/boot3.png
   :width: 7.48031in
   :height: 1.65708in
.. |image3| image:: media/boot5.png
   :width: 7.48031in
   :height: 1.65708in
.. |image4| image:: media/boot7.png
   :width: 7.48031in
   :height: 1.71595in
.. |image5| image:: media/boot9.png
   :width: 7.48031in
   :height: 1.71595in
.. |image6| image:: media/boot11.png
   :width: 7.48031in
   :height: 1.5167in
.. |image7| image:: media/boot13.png
   :width: 7.48031in
   :height: 1.71595in
.. |image8| image:: media/boot15.png
   :width: 7.48031in
   :height: 1.71595in
.. |image9| image:: media/boot17.png
   :width: 7.48031in
   :height: 1.91595in
.. |image10| image:: media/boot19.png
   :width: 7.48031in
   :height: 1.91595in
.. |image11| image:: media/boot21.png
   :width: 7.48031in
   :height: 1.91595in
.. |image12| image:: media/boot23.png
   :width: 7.48031in
   :height: 1.91595in
.. |image13| image:: media/boot25.png
   :width: 7.48031in
   :height: 1.91595in
.. |image14| image:: media/boot27.png
   :width: 7.48031in
   :height: 1.91595in
.. |image15| image:: media/boot29.png
   :width: 7.48031in
   :height: 1.91595in
.. |image16| image:: media/boot31.png
   :width: 7.48031in
   :height: 2.31595in
