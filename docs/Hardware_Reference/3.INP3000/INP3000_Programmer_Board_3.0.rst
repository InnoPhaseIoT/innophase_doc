.. _Hardware_Reference/3.INP3000/INP3000_Programmer_Board_3.0:

INP3000 Programmer Board 3.0
===========================
...
Figure 3: INP3000 programmer kit contents - version 3.0
...
Figure 4: Switch settings to select between SPI and UART
...
Figure 5: Connectors for application board

Use the mating connector on the Molex cable connected to FTDI board
version 3.0 in Figure 5 to independently program the Talaria TWO module.

.. |A picture containing text Description automatically generated| image:: media/image1.png
   :width: 5.11811in
   :height: 4.9996in
