...
.. table:: Table 26: BLE Provisioning - AT Commands
...
.. table:: Table 27: BLE Provisioning - AT Commands
...
Figure 94: BLE Provisioning- serial log
...
Figure 95: InnoPhase_Prov-GATT server
...
Figure 96: BLE write to add the SSID and Passphrase
...
.. table:: Table 28: BLE Provisioning - AT Commands
...
Figure 97: Acknowledgment of Write request

**Step 4**: Connect to the network with SSID=IP and
Passphrase=Inno@9070.

.. table:: Table 29: FOTA - AT commands
...
*(freertos_sdk_x.y\\binaries\\product\\at\\doc)*.
...
Figure 99: BLE Provisioning- serial log
...
Figure 100: innophase-GATT server
...
Figure 101: Randomly generated 6-digit Passkey
...
Figure 103: BLE write to add the SSID and Passphrase
...
Figure 104: Async data reception from mobile app
...
Figure 105: Acknowledgment of Write request
...
Figure 107: BLE Peripheral- serial log
...
Figure 108: BLE central- serial log
...
Figure 109: Acknowledgement of Write request
...
Figure 111: Generate the hash value
...
|                                                                       |
| "hash" :                                                              |
| "a93ce95fddea0f635f726311d0f8c912909858bfb8c9b4d4204ec5971d9d1aa4 "   |
|                                                                       |
| }                                                                     |
|                                                                       |
| ]                                                                     |
...
..
   ...
   Figure 112: Apache server setup link
...
..
   ...
   Figure 113: Folder to add the JSON and elf file
...
..
   ...
   Figure 114: HTTP File Server setup link
...
..
   ...
   Figure 115: Folder to add the JSON and elf file
...
..
   ...
   Figure 116: HTTP get from browser to verify server accessibility
...
+-----------------------------------------------------------------------+
| python3 ./script/program_flash.py --no_reset -i                       |
...
Figure 117 Generated root image

|image20|

Figure 118: Flashing the AT command ELF
...
Figure 120: Talaria TWO reset – console
...
..
   ...
   Figure 121: Updated file received - Talaria TWO console
...
| resp-len:9                                                            |
|                                                                       |
| CMD:at+wcon=InnoPhase,Inno@1234Hexdump of uartbuf before processing,  |
| len=28                                                                |
|                                                                       |
...
|                                                                       |
| hash =                                                                |
| 34aadc96b19b4aff23b08400523d427435be8aa0ff82b6084820165ceadc9174      |
|                                                                       |
| firmware                                                              |
|                                                                       |
| atcmd                                                                 |
...
| Calling http_client_open().                                           |
|                                                                       |
| fota_http_cb: resp->resp_len = 1252, resp->resp_total_len = 614932    |
| total_rcvd_len= 1252                                                  |
|                                                                       |
| fota_http_cb: resp->resp_len = 1460, resp->resp_total_len = 614932    |
| total_rcvd_len= 541452                                                |
|                                                                       |
| fota_http_cb: resp->resp_len = 1460, resp->resp_total_len = 614932    |
| total_rcvd_len= 579412                                                |
|                                                                       |
| fota_http_cb: resp->resp_len = 1460, resp->resp_total_len = 614932    |
| total_rcvd_len= 614452                                                |
|                                                                       |
| . fota_http_cb: resp->resp_len = 480, resp->resp_total_len = 614932   |
| total_rcvd_len= 614932                                                |
|                                                                       |
...
|                                                                       |
| image hash:                                                           |
| 34aadc96b19b4aff23b0840523d427435be8aa0ff82b684820165ceadc9174        |
|                                                                       |
| hash from cfg:                                                        |
| 34aadc96b19b4aff23b0840523d427435be8aa0ff82b684820165ceadc9174        |
|                                                                       |
...
|                                                                       |
| Bootargs: vm.flash_location=0x0003fc00 passphrase=123467890           |
| ssid=innotest                                                         |
|                                                                       |
...
.. |image6| image:: media/image6.png
   :width: 7.48031in
   :height: 4.86623in
.. |Graphical user interface Description automatically generated| image:: media/image7.png
   :width: 3.45773in
   :height: 4.62565in
.. |image7| image:: media/image8.png
   :width: 7.48031in
   :height: 5.67299in
.. |A screenshot of a computer Description automatically generated with medium confidence| image:: media/image9.png
   :width: 3.14961in
   :height: 4.49323in
...
.. |image16| image:: media/image18.png
   :width: 7.5in
   :height: 0.79097in
.. |Graphical user interface, text, application Description automatically generated| image:: media/image19.png
   :width: 6.29921in
   :height: 3.35246in
.. |Graphical user interface, text, application, email Description automatically generated| image:: media/image20.png
   :width: 5.90551in
   :height: 3.1661in
.. |A screenshot of a computer Description automatically generated| image:: media/image21.png
   :width: 5.90551in
   :height: 2.7918in
...
.. |image20| image:: media/image25.png
   :width: 6.88976in
   :height: 2.50264in
.. |Text Description automatically generated| image:: media/image26.png
   :width: 6.88976in
   :height: 1.09677in
.. |image21| image:: media/image27.png
   :width: 6.88976in
   :height: 4.77046in
.. |image22| image:: media/image28.png
   :width: 6.49606in
   :height: 3.14459in
.. |image23| image:: media/image29.png
   :width: 7.48031in
   :height: 3.0402in
