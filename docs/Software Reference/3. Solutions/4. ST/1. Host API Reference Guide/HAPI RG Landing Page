...
<<<<<<< HEAD:docs/Software Reference/STM/Host API Reference Guide/Host API Reference Guide-Landing.rst
**Wi-Fi Connection Manager**

=======
Wi-Fi Connection Manager
------------------------
>>>>>>> 6c33d3f0e13e0442461c682e79b39d74afd5a0a0:docs/Software Reference/3. Solutions/4. ST/1. Host API Reference Guide/HAPI RG Landing Page

This is the network connection manager which handles all the Wi-Fi
connection/disconnection.

**Socket Manager**

HIO handles all socket operations. It supports TCP, UDP, and raw
sockets.
