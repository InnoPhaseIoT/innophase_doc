...
|                                                                       |
| "wifi.scan_probe_tx_timeout", param.probe_tx_timeout /                |
| SYSTIME_MS(1));                                                       |
|                                                                       |
...
| param.max_responses                                                   |
|                                                                       |
| = os_get_boot_arg_int("wifi.scan_max_responses",                      |
| param.max_responses);                                                 |
+=======================================================================+
+-----------------------------------------------------------------------+
...
| dt_iterations=10, ap_logging=1, mpd.suspend=1                         |
+=======================================================================+
+-----------------------------------------------------------------------+
...
|                                                                       |
| Bootargs: wifi.scan_min_listen_time=8 wifi.scan_max_listen_time=24    |
| wifi.scan_num_probes=1 wifi.scan_idleslots=3 wifi.nap_scan=1          |
| dt_iterations=5000 ap_logging=1 mpd.suspend=1                         |
|                                                                       |
