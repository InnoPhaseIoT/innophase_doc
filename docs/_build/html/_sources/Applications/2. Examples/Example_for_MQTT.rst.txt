...
| 1,sub_qos=1,ca_cert=/data/mosquitto.org.crt,mqtt_no_poll=1,num_conn=1 |
+=======================================================================+
+-----------------------------------------------------------------------+
...
| data/client.crt,client_key=/data/client.key,mqtt_no_poll=1,num_conn=1 |
+=======================================================================+
+-----------------------------------------------------------------------+
...
|                                                                       |
| Bootargs: cloud_url=test.mosquitto.org cloud_port=1883 mqtt_no_poll=1 |
...
|                                                                       |
| app_wifi_status_cb: status = 124457wcm_notify_cb to App Layer -       |
...
| app_mqtt_conn_init                                                    |
|                                                                       |
| /home/synergic/Workspace/FreeRTOS/freertos_em                         |
| bedded_apps/components/mqtt/platform/mqtt_nw_tcp.c:MQTTNetworkConnect |
|                                                                       |
| Connecting ...                                                        |
|                                                                       |
...
| Flash detected. flash.hw.uuid: 39483937-3207-00b0-0064-ffffffffffff   |
|                                                                       |
| Bootargs: cloud_url=test.mosquitto.org cloud_port=8883                |
...
| app_mqtt_conn_init                                                    |
|                                                                       |
| /home/synergic/Workspace/FreeRTOS/freertos_embedd                     |
| ed_apps/components/mqtt/platform/mqtt_nw_tls.c:MQTTNetworkConnect_Tls |
|                                                                       |
...
| Flash detected. flash.hw.uuid: 39483937-3207-00b0-0064-ffffffffffff   |
|                                                                       |
| Bootargs: cloud_url=test.mosquitto.org cloud_port=8080                |
...
|                                                                       |
| Bootargs: cloud_url=172.16.16.30 cloud_port=9001                      |
| cloud_usr_name=innophase cloud_usr_psw=innophase mqtt_no_poll=1       |
...
| ssid=Xiaomi_Ax6000_iop passphrase=InnoQA2023$                         |
|                                                                       |
| $App:git-e719539                                                      |
|                                                                       |
| SDK Ver: FREERTOS_SDK_1.0                                             |
...
| MQTTNoPollInit:775                                                    |
|                                                                       |
| MQTTRun_NoPollThread: 719mac id:e0693a0166 T2 MQTT Client id :        |
| T2_e0693a0166_1                                                       |
|                                                                       |
...
| Flash detected. flash.hw.uuid: 39483937-3207-00b0-0064-ffffffffffff   |
|                                                                       |
| Bootargs: cloud_url= 192.168.1.105 cloud_port=1883                    |
| cloud_usr_name=innophase cloud_usr_psw=innophase ,mqtt_no_poll=1,     |
...
|                                                                       |
| MQTTRun_NoPollThread: 658mac id:234c2d50 T2 MQTT Client id :          |
| T2_234c2d50_1                                                         |
|                                                                       |
...
.. |image24| image:: media/image23.png
   :width: 3.14961in
   :height: 3.47452in
.. |image25| image:: media/image24.tmp
   :width: 5.51181in
   :height: 1.35733in
.. |image26| image:: media/image25.png
   :width: 5.51181in
   :height: 2.38165in
.. |image27| image:: media/image26.tmp
   :width: 5.51181in
   :height: 1.96044in
.. |image28| image:: media/image27.png
   :width: 5.51181in
   :height: 3.26837in
.. |image29| image:: media/image28.tmp
   :width: 5.51181in
   :height: 0.65205in
.. |image30| image:: media/image29.tmp
   :width: 5.7874in
   :height: 0.95916in
.. |image31| image:: media/image30.png
   :width: 5.7874in
   :height: 3.35239in
.. |image32| image:: media/image31.tmp
   :width: 5.7874in
   :height: 0.51552in
.. |image33| image:: media/image32.tmp
   :width: 5.90486in
   :height: 2.30417in
.. |image34| image:: media/image33.tmp
   :width: 5.7874in
   :height: 1.63313in
.. |image35| image:: media/image34.png
   :width: 5.7874in
   :height: 3.43555in
.. |image36| image:: media/image2.png
   :width: 5.7874in
   :height: 1.67968in
...
.. |image38| image:: media/image36.png
   :width: 5.90551in
   :height: 4.20719in
.. |image39| image:: media/image37.tmp
   :width: 7.07577in
   :height: 0.33958in
