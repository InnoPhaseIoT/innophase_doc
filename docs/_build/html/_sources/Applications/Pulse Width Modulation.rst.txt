...
.. table:: Table : PWM specification details
...
Programming Talaria TWO (pwm.elf)
---------------------------------

Program pwm.elf (*sdk_x.y\\examples\\pwm\\bin*) using the Download tool:
...
| Flash: Gordon ready!                                                  |
|                                                                       |
| Y-BOOT 208ef13 2019-07-22 12:26:54 -500 790da1-b-7                    |
|                                                                       |
...
Programming Talaria TWO (pwm_fade.elf)
--------------------------------------

Program pwm_fade.elf (*sdk_x.y\\examples\\pwm\\bin*) using the Download
tool:
...
Figure : Waveforms for 1MHz frequency with less than 5% duty cycle
...
Figure : Waveforms for 1MHz frequency with 50% duty cycle
...
Figure : Waveforms for 2MHz frequency with 50% duty cycle
...
Figure : Waveforms for 4MHz frequency with 50% duty cycle
...
Figure : Waveforms for 10MHz frequency with 50% duty cycle
...
Figure : Waveforms for 25KHz frequency with more than 50% duty cycle
