...
+-----------------------------------------------------------------------+
| $ ./custom_mqtt {mqttinit} <server name> <port number> <transport>    |
| <mqtt id> <usr name> <password> [ca cert] [client cert] [client key]  |
+=======================================================================+
+-----------------------------------------------------------------------+
...
|image3|\ |image4|\ |image5|\ |image6|\ |image7|\ |image8|\ |A
screenshot of a computer program Description automatically generated|

|image9|\ |image10|\ |image11|\ |A computer screen with white text
Description automatically generated|

|image12|\ |image13|\ |A computer screen shot Description automatically
generated|

Figure 3: custom_mqtt - Host console logs
...
|                                                                       |
| Image Name: Linux-3.10.14\__isvp_swan_1.0\_\_                         |
|                                                                       |
...
|                                                                       |
| [ 0.000000] Linux version 3.10.14\__isvp_swan_1.0\_\_                 |
| (lesly@synergic) (gcc ver3                                            |
|                                                                       |
...
|                                                                       |
| [ 0.000000] CCLK:1392MHz L2CLK:696Mhz H0CLK:200MHz H2CLK:200Mhz       |
| PCLK:100Mhz                                                           |
|                                                                       |
...
|                                                                       |
| [ 0.000000] Primary instruction cache 32kB, 8-way, VIPT, linesize 32  |
| bytes.                                                                |
|                                                                       |
...
| Total p6                                                              |
|                                                                       |
| [ 0.000000] Kernel command line: console=ttyS1,115200n8 mem=64M@0x0   |
| rmem=64M)                                                             |
|                                                                       |
...
| bytes)                                                                |
|                                                                       |
| [ 0.000000] Memory: 58512k/65536k available (4389k kernel code, 7024k |
| reserv)                                                               |
|                                                                       |
...
|                                                                       |
| [ 0.130351] TCP established hash table entries: 512 (order: 0, 4096   |
| bytes)                                                                |
|                                                                       |
...
|                                                                       |
| [ 0.368857] dma dma0chan17: Channel 17 have been requested.(phy id    |
| 14,type 0)                                                            |
|                                                                       |
| [ 0.377805] dma dma0chan18: Channel 18 have been requested.(phy id    |
| 13,type 0)                                                            |
|                                                                       |
...
|                                                                       |
| hapi_wcm_create:112 DEBUG:WiFi interface created with mac addr:       |
| E2:69:3A:00:04:E                                                      |
|                                                                       |
| Tunadaptor ready...                                                   |
|                                                                       |
...
|                                                                       |
| .amazonaws.com 8883 1 T2_MAC apps-dev@innophaseiot.com InnoCloud2020  |
| /data/aws_r                                                           |
|                                                                       |
...
.. |image8| image:: media/image1.png
   :width: 0.9in
   :height: 0.13333in
.. |A screenshot of a computer program Description automatically generated| image:: media/image3.png
   :width: 6.29921in
   :height: 4.62059in
...
.. |image11| image:: media/image1.png
   :width: 0.9in
   :height: 0.21667in
.. |A computer screen with white text Description automatically generated| image:: media/image4.png
   :width: 6.29921in
   :height: 1.60805in
...
.. |image13| image:: media/image1.png
   :width: 0.9in
   :height: 0.11667in
.. |A computer screen shot Description automatically generated| image:: media/image5.png
   :width: 6.29921in
   :height: 0.9583in
